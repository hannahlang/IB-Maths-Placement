...
class prepare_clean_df(BaseEstimator, TransformerMixin):
    ...
    #Functions to clean placement data
...
class math_placement_prediction_model(BaseEstimator, TransformerMixin):
    ...
    def predict(self, X, c_i = 95, plot = True):
        ...
        if plot:
            ...
            plt.xlabel('Sample')
            plt.ylabel('Pred_proba of Predicted Class')
...
You will need to have an average of a [PERCENTAGE]% in assessments in this by the start of the fall holidays, \
